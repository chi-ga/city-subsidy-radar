...
function PathCard({ onClick, icon, color, title, description }: PathCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className={`group flex h-[104px] w-full shrink-0 items-center gap-3 rounded-xl border border-slate-200 bg-white p-3.5 text-left shadow-sm transition-all ${c.borderHover} hover:shadow-md active:scale-[0.995] sm:gap-4 lg:h-24 lg:p-3.5`}
    >
      <div
