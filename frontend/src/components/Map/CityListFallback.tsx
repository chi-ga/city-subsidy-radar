...
const COVERED_CITIES = [
  ...
  { code: 'changsha', name: '长沙', count: 2 },
  { code: 'chengdu', name: '成都', count: 11 },
  { code: 'jinan', name: '济南', count: 3 },
  { code: 'shaoxing', name: '绍兴', count: 18 },
  { code: 'zhuhai', name: '珠海', count: 4 },
  ...
  { code: 'jiaozuo', name: '焦作', count: 6 },
  { code: 'jining', name: '济宁', count: 3 },
  { code: 'hengyang', name: '衡阳', count: 5 },
