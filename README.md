...
**项目状态**：持续迭代中。已完成 115 城覆盖，全部城市政策数据已校对，如发现数据错误欢迎提 Issue 反馈。

**当前覆盖城市（115 个）**：北京、上海、深圳、广州、杭州、南京、成都、武汉、合肥、嘉兴、泉州、温州、宁波、长沙、济南、绍兴、珠海、南宁、郑州、青岛、无锡、福州、厦门、南昌、昆明、天津、苏州、西安、东莞、佛山、惠州、中山、海口、三亚、贵阳、沈阳、大连、长春、哈尔滨、石家庄、烟台、南通、常州、徐州、唐山、芜湖、太原、兰州、洛阳、潍坊、赣州、银川、呼和浩特、临沂、金华、台州、保定、盐城、扬州、泰州、镇江、连云港、淮安、宿迁、乌鲁木齐、西宁、拉萨、淄博、绵阳、桂林、汕头、湛江、九江、宜昌、襄阳、株洲、岳阳、蚌埠、马鞍山、漳州、淮南、淮北、铜陵、安庆、黄山、滁州、阜阳、宿州、六安、亳州、池州、宣城、荆州、荆门、鄂州、黄冈、威海、沧州、南阳、鞍山、吉林市、鄂尔多斯、焦作、济宁、衡阳、新乡、盘锦、大庆、宁德、开封、周口、德阳、宝鸡、自贡、重庆
...
| **哪个城市对我更好** | 不选城市，同时对比 115 城补贴总额，支持一键过滤购房补贴 |
| **查看政策** | 按城市、区域、类型筛选浏览全部政策 |

### 核心功能

- **院校自动补全** — 1,190 所院校（840 所国内 + 350 所境外），支持中文/拼音/简称/别名搜索，自动标记 985/211/双一流/省重点等层次
- **专业自动补全** — 805 个本科专业（12 门类、93 专业类，含 2024 年新增专业）+ 研究生学科目录，一级学科采用 2022 版标准，深圳模式自动判定重点产业领域
...
- **多城对比过滤购房补贴** — 一键排除大额购房补贴，避免对比结果被买房条件主导
- **收藏夹** — 感兴趣的政策一键收藏，方便对比与后续查看
- **回到顶部** — 长页面滚动后一键返回顶部
- **纸质文件风格卡片** — 政策库卡片采用文件头 + 纸纹质感，信息层级更清晰

### 数据规模

| 数据类型 | 数量 | 说明 |
|---------|------|------|
| 覆盖城市 | 115 个 | 北上广深 + 杭州、南京、成都、武汉等新一线及二三线城市，覆盖全国主要城市 |
| 补贴政策 | 581 条 | 覆盖 115 个城市的生活补贴、租房补贴、购房补贴、人才奖励等 |
| 院校数据 | 1,190 所 | 840 所国内高校（39 所 985 + 116 所 211 + 147 所双一流 + 244 所省重点 + 普通本科）+ 350 所境外高校 |
| 本科专业 | 805 个 | 12 个门类、93 个专业类，含 2024 年新增专业，一级学科名称采用 2022 年版研究生教育学科专业目录 |
| 双一流学科 | 147 校 × 501 条 | 第二轮双一流建设高校及学科 |
| 深圳重点产业专业 | 255 个 | 57 个研究生学科 + 198 个本科专业 |
| 拔尖计划基地 | 199 个 | 60 所高校，基础学科拔尖学生培养计划 2.0 |

> ⚠️ **数据准确性说明**：全部 115 城政策数据已校对，匹配结果可靠。如发现任何数据错误，欢迎提 Issue 反馈，我们会尽快修正。
...
│   │   │   └── CompareBuyFilterButton.tsx # 对比页过滤购房补贴按钮
│   │   ├── data/               # 静态数据
...
3. **Issue** — 发现数据错误或有建议，欢迎提 Issue（尤其是非北上广深城市的数据问题）
4. **PR** — 欢迎提交 PR，一起完善项目
...
- [x] 逐一审核校对全部 115 城政策数据，提升准确性
- [ ] 补充更多补贴政策数据
- [x] 开放 AI 个性化解读功能入口（设置页已上线）
- [x] 优化移动端体验（已阶段性完成，持续迭代）
- [ ] 添加政策更新提醒
