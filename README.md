...
**项目状态**：持续迭代中。已完成 64 城覆盖，北京、上海、深圳、广州四城数据经过仔细审核校对，其余城市已上线但尚未逐一复核，如发现数据错误欢迎提 Issue 反馈。

**当前覆盖城市（64 个）**：北京、上海、深圳、广州、杭州、南京、成都、武汉、合肥、嘉兴、泉州、温州、宁波、长沙、济南、绍兴、珠海、南宁、郑州、青岛、无锡、福州、厦门、南昌、昆明、天津、苏州、西安、东莞、佛山、惠州、中山、海口、贵阳、沈阳、大连、长春、哈尔滨、石家庄、烟台、南通、常州、徐州、唐山、芜湖、太原、兰州、洛阳、潍坊、赣州、银川、呼和浩特、临沂、金华、台州、保定、盐城、扬州、泰州、镇江、连云港、淮安、宿迁
...
| **哪个城市对我更好** | 不选城市，同时对比 64 城补贴总额，支持一键过滤购房补贴 |
| **查看政策** | 按城市、区域、类型筛选浏览全部政策 |

### 核心功能

- **院校自动补全** — 1,191 所院校（827 所国内 + 364 所境外），支持中文/拼音/简称/别名搜索，自动标记 985/211/双一流/省重点等层次
...
| 数据类型 | 数量 | 说明 |
|---------|------|------|
| 覆盖城市 | 64 个 | 北上广深 + 杭州、南京、成都、武汉等新一线及二三线城市 |
| 补贴政策 | 320+ 条 | 覆盖 64 个城市的生活补贴、租房补贴、购房补贴、人才奖励等 |
| 院校数据 | 1,191 所 | 827 所国内高校（39 所 985 + 116 所 211 + 147 所双一流 + 244 所省重点 + 436 所普通本科）+ 364 所境外高校 |
...
> ⚠️ **数据准确性说明**：北京、上海、深圳、广州四城的政策数据经过仔细审核校对，匹配结果较为可靠。其余 60 个城市的数据已上线，但尚未逐一人工复核，可能存在政策条件提取不准确、金额有误等情况。如发现任何数据错误，欢迎提 Issue 反馈，我们会尽快修正。
